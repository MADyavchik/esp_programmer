...
try:
    ...
    st_device = ST7789(width=240, height=240, dc=23, reset=24, bl=12, enable_backlight=True)
...
async def inactivity_watcher(sleep_timeout=600):
    backlight_on = True
...
def draw_menu(
    ...
    for i in range(visible_lines):
        ...
        if index == selected_index and not is_label:
            ...
            color = "grey" if not is_label else "antiquewhite"
